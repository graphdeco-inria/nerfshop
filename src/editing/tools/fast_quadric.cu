...
namespace Simplification {
    ...
    bool FastQuadric::flipped(vec3f p,int i0,int i1,Vertex &v0,Vertex &v1,std::vector<int> &deleted)
    {
    ...
    void FastQuadric::update_uvs(int i0,const Vertex &v,const vec3f &p,std::vector<int> &deleted)
    {
        loopk(0,v.tcount)
        {
    ...
    void FastQuadric::update_triangles(int i0,Vertex &v,std::vector<int> &deleted,int &deleted_triangles)
    {
        vec3f p;
        loopk(0,v.tcount)
        {
    ...
    void FastQuadric::update_mesh(int iteration)
    {
    ...
    double FastQuadric::vertex_error(SymetricMatrix q, double x, double y, double z)
    {
    ...
    double FastQuadric::calculate_error(int id_v1, int id_v2, vec3f &p_result)
    {
